...
const accessibleFeatureSource = {
  ...
  ARAB_MIDDLE_EASTERN: 1,
  ASIAN_PACIFIC_ISLANDER: 1,
  BLACK_AFRICAN_AMERICAN_AFRICAN: 1,
  'CARIBBEAN_INDO-CARIBBEAN': 1,
  HISPANIC_LATINO_A_X: 1,
  SOUTH_ASIAN: 1,
  JEWISH: 1,
  HINDU: 1,
  MUSLIM: 1,
  SIKH: 1,
  INDIGENOUS_FIRST_PEOPLE_AMERICAN_INDIAN_NATIVE_AMERICAN: 1,
  'LGBTQ+': 1,
  TRANSGENDER_AND_GENDER_NONCONFORMING_FOCUS: 1,
